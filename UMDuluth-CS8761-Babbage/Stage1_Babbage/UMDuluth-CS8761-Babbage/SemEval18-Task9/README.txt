...
* 		Jose Camacho-Collados, Claudio Delli Bovi, Luis Espinosa-Anke, Roberto Navigli,       *
*		Sergio Oramas, Tommaso Pasini, Horacio Saggion, Enrico Santus, Vered Shwartz          *
*												      *
*******************************************************************************************************


This package contains the trial and training data for the SemEval 2018 task 9 on Hypernym Discovery. 

In addition to this README file, there is a directory containing the trial data ("trial"), training data
("training"), another one containing the full space of candidate hypernyms up to trigrams ("vocabulary")
and a Python evaluation script ("task9-scorer.py"):
...
the final evaluation script is case-insensitive. In this list very specific hypernyms such as topic, entity, 
etc. which are not considered in the gold standard have been filtered, as well as those occuring less than 
...
* data
	...
	- contains the trial data for all five subtasks, each line corresponding to a term and its type (Concept or Entity): 
		term <tab> type


* gold

	- contains gold standard hypernyms for all the datasets (tab-separated), each line corresponding to the same line
