...
#=====================================================================================
# 		HAVING VARIABLES WHICH ARE ONLY NEEDED FOR METHOD 3
#		METHOD 3 WILL NOT WORK WITH TRAINING DATA - JUST FOR TEST DATA
#=====================================================================================
...
# Run on TRIAL/TEST
RUN_ON_TRIAL=true			# DO NOT MODIFY IT TO DALSE AS METHOD 3 IS NOT SET UP FOR TRAINING DATA YET AS THE MAP IS UNAVAILABLE
...
CREATE_DIC_FILE_NORM=false				# ALWAYS false FOR THIS CASE
CREATE_RES_FROM_DIC_FILE_NORM=true		# ALWAYS true FOR THIS CASE
...
CREATE_DIC_FILE_HEARST=false			# ALWAYS false FOR THIS CASE
CREATE_RES_FROM_DIC_FILE_HEARST=true	# ALWAYS true FOR THIS CASE
